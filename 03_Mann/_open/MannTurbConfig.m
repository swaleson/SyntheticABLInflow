...
% Turbulence.alphaeps: 	0.18 	-> 1.3; % energy level constant
% Turbulence.L: 		49		-> 29;   % turbulence length scale 
% Turbulence.Gamma:		3.37	-> 3.5;  % anisotropy
% Turbulence.gamma:   	430		-> 400;  % time constant for eddy life time
% Turbulence.factor(2):	3.5		-> 2.5;    % eddy life time slope
% Turbulence.alpha_shear: 0.2	-> 0.15;  % shear exponent  
...
case 'Neutral'   
	...
	Turbulence.alphaeps          = 1.3; % energy level constant
    Turbulence.L                 = 29;   % turbulence length scale 
    ...
    Turbulence.alpha_shear = 0.15;  % shear exponent  
