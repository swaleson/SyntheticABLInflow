...
% Turbulence.alphaeps: 	0.18 	-> 3; % energy level constant
% Turbulence.L: 		49		-> 57;   % turbulence length scale 
...
% Turbulence.alpha_shear: 0.2	-> 0.3;  % shear exponent  
...
Turbulence.alphaeps          = 3; % energy level constant
    Turbulence.L                 = 57;   % turbulence length scale 
    ...
    Turbulence.alpha_shear = 0.3;  % shear exponent  
