...
# Overview 
- References to the synthetic inflow generation method sources (external)
- OpenFOAM base cases for the three versions required.
- input and reference data used in the comparison for the open, suburban, and urban case
