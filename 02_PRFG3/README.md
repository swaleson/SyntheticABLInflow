...
After the .zip is downloaded and unpacked, the directories *CodeOF*, *inflowCorrection*, and *inflowGeneration* are copied into the base_case. 

Preparation: Copy mesh into inflowCorrection directory. 
